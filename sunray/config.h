...
#define MOWPOWERMAX_AUTO            true  // uses actual measured mowPower during operation, if true MOWPOWERMAX is ignored
...
#define ESCAPE_LAWN_MOWMOTORPOWER   false  //not yet implemented... will get rid of RPM triggers and use power of mowmotor instead of rpm readings to trigger this function (testing)
